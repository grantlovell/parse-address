...
class ObjectBase
{
     ...
     * @return  boolean
     */
    public function bind($from, $ignore = array(), $public = false)
    {
     ...
     * @param $string
     */
    public function createCamel($string = null)
    {
        //reasons to fail
        if (is_null($string)) {
            return false;
     ...
     * @return boolean
     */
    public function fireMethod($method = null, $args = null)
    {
        //reasons to fail
     ...
     * @param $private
     */
    public function getMethods($prefix = null, $private = false)
    {
        //initializing variables
        ...
        foreach ($methods as $key => $method) {
            ...
            if (! is_null($prefix)) {
                if (substr($method, 0, $prelen) != $prefix) {
                    unset($methods[$key]);
                }
            }
        }
     ...
     * @return boolean
     */
    public function _isset($property = null)
    {
        //reasons to fail
        if (!($this->$property)) {
            return false;
