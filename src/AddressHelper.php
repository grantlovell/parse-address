...
{
    /**
     * Get me a reversed array
     *
     * Method contains static values of the reversed arrays
     *
     * @param $array_name
     * @return array
     */
    public static function getReverseArray($array_name = null)
    {
        ...
        if (!isset($_reversed[$array_name])) {
            $_reversed[$array_name] = array_flip(self::getArray($array_name));
        }

        return $_reversed[$array_name];
    }

    /**
     * Get the total combined array
     *
     * @param string $array_name
     * @return array
     */
    public static function getTotalArray($array_name = null)
    {
        //reasons to fail
        if (!self::getArray($array_name)) {
            return false;
        }
        ...
        if (!isset($total[$array_name])) {
            $reversed = self::getReverseArray($array_name);
            $array = self::getArray($array_name);

            $total[$array_name] = $array + $reversed;
        }

        return $total[$array_name];
    }
     ...
     */
    public static function getArray($property = null)
    {
        static $array;
    ...
    /**
     * Array of subpremises
     *
     * @var array
     */
    protected $_subpremises = [
        'APARTMENTS'=>'APT',
        'APTS'=>'APT',
        'ROOMS'=>'RM',
        'RMS'=>'RM',
    ...
    /**
     * Contains an array of directional attributes
     *
     * @var array
     */
    protected $_directions = array('NORTH'=>'N',
        'NORTHNORTHEAST'=>'NNE',
    'NORTHNORTH EAST'=>'NNE',
    'NORTH NORTHEAST'=>'NNE',
    'NORTHEAST'=>'NE',
    ...
    /**
     * Contains an array of street prefixes
     *
     * @var array
     */
    protected $_streets = array('AIR'=>'AIR',
        'AR'=>'AIR',
    'ALLEE'=>'ALY',
    'ALLEY'=>'ALY',
    'ALLY '=>'ALY',
    ...
    /**
     * Contains a list of states so that we can match these to
     * address parts
     *
     * @var array
     */
    protected $_states = array('ALABAMA'=>'AL',
        'ALASKA'=>'AK',
    'AMERICAN SAMOA'=>'AS',
    'ARIZONA'=>'AZ',
    'ARKANSAS'=>'AR',
    ...
    /**
     * Contains a list of sovereign countries so that we can match these to
     * address parts
     *
     * @var array
     */
    protected $_countries = array('UNITED STATES'=>'USA',
        'UNITED STATES'=>'US ',
    'AFGHANISTAN'=>'AF',
    'ALBANIA'=>'AL',
    'ALGERIA'=>'DZ',
    ...
    /**
     * Holds the multidemensional array of counties
     *
     * @var array
     */
    protected $_counties = array(
        ...
        'LINCOLN','LOGAN','LOUP','MCPHERSON','MADISON','MERRICK','MORRILL','NANCE','NEMAHA',
        ...
        'NV' =>
        array('CHURCHILL','CLARK','DOUGLAS','ELKO','ESMERALDA','EUREKA','HUMBOLDT','LANDER',
        'LINCOLN','LYON','MINERAL','NYE','PERSHING','STOREY','WASHOE','WHITE PINE',
        'CARSON CITY CITY'),
        'NH' =>
        array('BELKNAP','CARROLL','CHESHIRE','COOS','GRAFTON','HILLSBOROUGH','MERRIMACK',
        'ROCKINGHAM','STRAFFORD','SULLIVAN'),
        'NJ' =>
        array('ATLANTIC','BERGEN','BURLINGTON','CAMDEN','CAPE MAY','CUMBERLAND','ESSEX',
        'GLOUCESTER','HUDSON','HUNTERDON','MERCER','MIDDLESEX','MONMOUTH','MORRIS','OCEAN',
        'PASSAIC','SALEM','SOMERSET','SUSSEX','UNION','WARREN'),
        'NM' =>
        array('BERNALILLO','CATRON','CHAVES','CIBOLA','COLFAX','CURRY','DE BACA','DONA ANA',
        'EDDY','GRANT','GUADALUPE','HARDING','HIDALGO','LEA','LINCOLN','LOS ALAMOS','LUNA',
        'MCKINLEY','MORA','OTERO','QUAY','RIO ARRIBA','ROOSEVELT','SANDOVAL','SAN JUAN',
        'SAN MIGUEL','SANTA FE','SIERRA','SOCORRO','TAOS','TORRANCE','UNION','VALENCIA'),
        'NY' =>
        array('ALBANY','ALLEGANY','BRONX','BROOME','CATTARAUGUS','CAYUGA','CHAUTAUQUA',
        'CHEMUNG','CHENANGO','CLINTON','COLUMBIA','CORTLAND','DELAWARE','DUTCHESS','ERIE',
        'ESSEX','FRANKLIN','FULTON','GENESEE','GREENE','HAMILTON','HERKIMER','JEFFERSON',
        ...
        'NC' =>
        array('ALAMANCE','ALEXANDER','ALLEGHANY','ANSON','ASHE','AVERY','BEAUFORT','BERTIE',
        ...
        'IREDELL','JACKSON','JOHNSTON','JONES','LEE','LENOIR','LINCOLN','MCDOWELL','MACON',
        'MADISON','MARTIN','MECKLENBURG','MITCHELL','MONTGOMERY','MOORE','NASH','NEW HANOVER',
        ...
        'YADKIN','YANCEY'),
        'ND' =>
        array('ADAMS','BARNES','BENSON','BILLINGS','BOTTINEAU','BOWMAN','BURKE','BURLEIGH',
        'CASS','CAVALIER','DICKEY','DIVIDE','DUNN','EDDY','EMMONS','FOSTER','GOLDEN VALLEY',
        'GRAND FORKS','GRANT','GRIGGS','HETTINGER','KIDDER','LA MOURE','LOGAN','MCHENRY',
        ...
        'WARD','WELLS','WILLIAMS'),
        'OH' =>
        array('ADAMS','ALLEN','ASHLAND','ASHTABULA','ATHENS','AUGLAIZE','BELMONT','BROWN',
        ...
        'OK' =>
        array('ADAIR','ALFALFA','ATOKA','BEAVER','BECKHAM','BLAINE','BRYAN','CADDO','CANADIAN',
        ...
        'KAY','KINGFISHER','KIOWA','LATIMER','LE FLORE','LINCOLN','LOGAN','LOVE','MCCLAIN',
        'MCCURTAIN','MCINTOSH','MAJOR','MARSHALL','MAYES','MURRAY','MUSKOGEE','NOBLE','NOWATA',
        'OKFUSKEE','OKLAHOMA','OKMULGEE','OSAGE','OTTAWA','PAWNEE','PAYNE','PITTSBURG',
        'PONTOTOC','POTTAWATOMIE','PUSHMATAHA','ROGER MILLS','ROGERS','SEMINOLE','SEQUOYAH',
        'STEPHENS','TEXAS','TILLMAN','TULSA','WAGONER','WASHINGTON','WASHITA','WOODS',
        'WOODWARD'),
        'OR' =>
        array('BAKER','BENTON','CLACKAMAS','CLATSOP','COLUMBIA','COOS','CROOK','CURRY',
        ...
        'PA' =>
        array('ADAMS','ALLEGHENY','ARMSTRONG','BEAVER','BEDFORD','BERKS','BLAIR','BRADFORD',
        ...
        'ELK','ERIE','FAYETTE','FOREST','FRANKLIN','FULTON','GREENE','HUNTINGDON','INDIANA',
        ...
        'RI' =>
        array('BRISTOL','KENT','NEWPORT','PROVIDENCE','WASHINGTON'),
        'SC' =>
        array('ABBEVILLE','AIKEN','ALLENDALE','ANDERSON','BAMBERG','BARNWELL','BEAUFORT',
        ...
        'LAURENS','LEE','LEXINGTON','MCCORMICK','MARION','MARLBORO','NEWBERRY','OCONEE',
        'ORANGEBURG','PICKENS','RICHLAND','SALUDA','SPARTANBURG','SUMTER','UNION',
        'WILLIAMSBURG','YORK'),
        'SD' =>
        array('AURORA','BEADLE','BENNETT','BON HOMME','BROOKINGS','BROWN','BRULE','BUFFALO',
        ...
        'MCPHERSON','MARSHALL','MEADE','MELLETTE','MINER','MINNEHAHA','MOODY','PENNINGTON',
        'PERKINS','POTTER','ROBERTS','SANBORN','SHANNON','SPINK','STANLEY','SULLY','TODD',
        'TRIPP','TURNER','UNION','WALWORTH','YANKTON','ZIEBACH'),
        'TN' =>
        array('ANDERSON','BEDFORD','BENTON','BLEDSOE','BLOUNT','BRADLEY','CAMPBELL','CANNON',
        'CARROLL','CARTER','CHEATHAM','CHESTER','CLAIBORNE','CLAY','COCKE','COFFEE','CROCKETT',
        ...
        'LAWRENCE','LEWIS','LINCOLN','LOUDON','MCMINN','MCNAIRY','MACON','MADISON','MARION',
        'MARSHALL','MAURY','MEIGS','MONROE','MONTGOMERY','MOORE','MORGAN','OBION','OVERTON',
        ...
        'TX' =>
        array('ANDERSON','ANDREWS','ANGELINA','ARANSAS','ARCHER','ARMSTRONG','ATASCOSA',
        ...
        'BURNET','CALDWELL','CALHOUN','CALLAHAN','CAMERON','CAMP','CARSON','CASS','CASTRO',
        'CHAMBERS','CHEROKEE','CHILDRESS','CLAY','COCHRAN','COKE','COLEMAN','COLLIN',
        'COLLINGSWORTH','COLORADO','COMAL','COMANCHE','CONCHO','COOKE','CORYELL','COTTLE',
        'CRANE','CROCKETT','CROSBY','CULBERSON','DALLAM','DALLAS','DAWSON','DEAF SMITH',
        'DELTA','DENTON','DE WITT','DICKENS','DIMMIT','DONLEY','DUVAL','EASTLAND','ECTOR',
        'EDWARDS','ELLIS','EL PASO','ERATH','FALLS','FANNIN','FAYETTE','FISHER','FLOYD','FOARD',
        'FORT BEND','FRANKLIN','FREESTONE','FRIO','GAINES','GALVESTON','GARZA','GILLESPIE',
        'GLASSCOCK','GOLIAD','GONZALES','GRAY','GRAYSON','GREGG','GRIMES','GUADALUPE','HALE',
        ...
        'HOUSTON','HOWARD','HUDSPETH','HUNT','HUTCHINSON','IRION','JACK','JACKSON','JASPER',
        'JEFF DAVIS','JEFFERSON','JIM HOGG','JIM WELLS','JOHNSON','JONES','KARNES','KAUFMAN',
        'KENDALL','KENEDY','KENT','KERR','KIMBLE','KING','KINNEY','KLEBERG','KNOX','LAMAR',
        'LAMB','LAMPASAS','LA SALLE','LAVACA','LEE','LEON','LIBERTY','LIMESTONE','LIPSCOMB',
        'LIVE OAK','LLANO','LOVING','LUBBOCK','LYNN','MCCULLOCH','MCLENNAN','MCMULLEN',
        'MADISON','MARION','MARTIN','MASON','MATAGORDA','MAVERICK','MEDINA','MENARD','MIDLAND',
        ...
        'UT' =>
        array('BEAVER','BOX ELDER','CACHE','CARBON','DAGGETT','DAVIS','DUCHESNE','EMERY',
        ...
        'WAYNE','WEBER'),
        'VT' =>
        array('ADDISON','BENNINGTON','CALEDONIA','CHITTENDEN','ESSEX','FRANKLIN','GRAND ISLE',
        'LAMOILLE','ORANGE','ORLEANS','RUTLAND','WASHINGTON','WINDHAM','WINDSOR'),
        'VA' =>
        array('ACCOMACK','ALBEMARLE','ALLEGHANY','AMELIA','AMHERST','APPOMATTOX','ARLINGTON',
        ...
        'PITTSYLVANIA','POWHATAN','PRINCE EDWARD','PRINCE GEORGE','PRINCE WILLIAM','PULASKI',
        'RAPPAHANNOCK','RICHMOND','ROANOKE','ROCKBRIDGE','ROCKINGHAM','RUSSELL','SCOTT',
        'SHENANDOAH','SMYTH','SOUTHAMPTON','SPOTSYLVANIA','STAFFORD','SURRY','SUSSEX','TAZEWELL',
        'WARREN','WASHINGTON','WESTMORELAND','WISE','WYTHE','YORK','ALEXANDRIA','BRISTOL',
        'BUENA VISTA','CHARLOTTESVILLE','CHESAPEAKE','CLIFTON FORGE','COLONIAL HEIGHTS',
        'COVINGTON','DANVILLE','EMPORIA','FALLS CHURCH','FREDERICKSBURG','GALAX','HAMPTON',
        ...
        'RADFORD','SALEM','SOUTH BOSTON','STAUNTON','SUFFOLK','VIRGINIA BEACH','WAYNESBORO',
        'WILLIAMSBURG','WINCHESTER'),
        'WA' =>
        array('ADAMS','ASOTIN','BENTON','CHELAN','CLALLAM','CLARK','COLUMBIA','COWLITZ',
        ...
        'WV' =>
        array('BARBOUR','BERKELEY','BOONE','BRAXTON','BROOKE','CABELL','CALHOUN','CLAY',
        ...
        'MARION','MARSHALL','MASON','MERCER','MINERAL','MINGO','MONONGALIA','MONROE','MORGAN',
        ...
        'WI' =>
        array('ADAMS','ASHLAND','BARRON','BAYFIELD','BROWN','BUFFALO','BURNETT','CALUMET',
        ...
        'PORTAGE','PRICE','RACINE','RICHLAND','ROCK','RUSK','ST. CROIX','SAUK','SAWYER',
        'SHAWANO','SHEBOYGAN','TAYLOR','TREMPEALEAU','VERNON','VILAS','WALWORTH','WASHBURN',
        'WASHINGTON','WAUKESHA','WAUPACA','WAUSHARA','WINNEBAGO','WOOD'),
        'WY' =>
        array('ALBANY','BIG HORN','CAMPBELL','CARBON','CONVERSE','CROOK','FREMONT','GOSHEN',
    ...
    /**
     * Holds the multidemensional array of cities
     *
     * @var array
     */
